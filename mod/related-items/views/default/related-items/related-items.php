            ...
            if ($related_item instanceof ElggObject) // ensure the item is not a group or other object type
            {
                ...
                {		
                    switch($this_subtype)
                    {
                        ...
                        case 'au_set':
                        {
                            $icon_url = $related_item->getIconURL('small');				$icon_url = $icon_url ?: '';
                            break;
                        }
                        case 'file':
                        {
                ...
                if($show_tags ==='yes')
                {
                    ...
                    {
                        $related_item_tags = array($related_item->tags);
                    }
                    else
                    {
                    ...
                    $tag_output = "<br/><small>";
                    $tag_output .= elgg_view('output/tags',array('value'=>$matched_tags));
                    $tag_output .= "</small>";
                    echo $tag_output;
                }
